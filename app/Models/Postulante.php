...
class Postulante extends Model
{
    ...
    protected $casts = [
        ...
        'regiones_interes' => 'json:unicode',
        'industrias_interes' => 'json:unicode',
        'habilidades' => 'json:unicode',
        'modalidad_trabajo' => 'json:unicode',
        'educaciones' => 'json:unicode',
        'idiomas' => 'json:unicode',
        'experiencias' => 'json:unicode',
     ...
     */
    public function publicacionesAsociadas(): BelongsToMany
    {
        return $this->belongsToMany(Publicacion::class, 'publicacion_candidato')
