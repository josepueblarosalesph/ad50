<div class="ad-panel">
    ...
    <x-slot:nav>
        ...
        <a wire:navigate href="{{ route('empresa.busquedas.index') }}" class="text-[13.5px] font-semibold px-3.5 py-2 rounded-lg text-gray-500 hover:text-ink">Procesos</a>
    ...
    <section class="ad-card overflow-hidden">
        ...
        <div class="overflow-x-auto"><table class="w-full text-[14px]"><thead><tr class="border-b border-line text-left text-[12px] uppercase tracking-wider text-gray-400"><th class="p-4">Proceso</th><th class="p-4">Candidatos</th><th class="p-4">Estado</th><th class="p-4"></th></tr></thead><tbody>
