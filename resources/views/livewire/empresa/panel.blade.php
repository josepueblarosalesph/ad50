<div class="ad-panel">
    ...
    <x-slot:sidebar>
        <div class="mb-2 px-2.5 text-[12px] font-bold uppercase tracking-[0.12em] text-gray-400">Selección</div>
        ...
        <div class="mt-5 mb-2 px-2.5 text-[12px] font-bold uppercase tracking-[0.12em] text-gray-400">Cuenta</div>
    ...
    <section class="ad-card overflow-hidden">
        <div class="ad-card-head"><h2 class="text-[16px] font-bold">Mis búsquedas recientes</h2><a href="{{ route('empresa.busquedas.create') }}" class="text-[14px] font-semibold text-orange-600">+ Nueva</a></div>
