<div>
    ...
    <div class="ad-candidate-toolbar mb-5 flex flex-wrap items-center justify-between gap-3 rounded-2xl border p-2.5 shadow-sm">
        @if ($origen === 'favoritos')
            <a wire:navigate href="{{ route('empresa.favoritos') }}" class="inline-flex items-center gap-2 px-2 text-[13px] font-semibold text-gray-500 hover:text-ink"><flux:icon.arrow-left class="size-4" />Volver a Mis favoritos</a>
        @else
