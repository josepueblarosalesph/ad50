<div id="filtros-busqueda" class="pb-5 pr-1">
    ...
    <form wire:submit="guardar" class="space-y-2.5">
        ...
        <div class="rounded-xl border border-line-2 bg-white p-3 transition-colors dark:bg-[#222528]"><flux:input wire:model="aniosMinimos" type="number" min="0" max="80" label="Experiencia mínima" /></div>
        <div class="rounded-xl border border-line-2 bg-white p-3 transition-colors dark:bg-[#222528]"><flux:input wire:model="palabraClave" label="Palabra clave" /></div>
