<div class="ad-panel">
    ...
    <x-slot:nav>
        ...
        <a wire:navigate href="{{ route('empresa.publicaciones.index') }}" class="rounded-lg px-3.5 py-2 text-[13.5px] font-semibold text-gray-500 hover:text-ink">Publicaciones</a>
