    ...
    <main class="max-w-[1180px] mx-auto px-6 md:px-11 py-16">
        ...
        @if ($planPostulante)
            <div class="ad-card p-5 mt-6 flex flex-wrap items-center justify-between gap-4">
                <div><b class="text-[14px]">¿Eres postulante?</b><p class="text-[12.5px] text-gray-500 mt-1">{{ $planPostulante->nombre }} por ${{ number_format($planPostulante->precio_clp, 0, ',', '.') }} CLP {{ $planPostulante->periodo }}.</p></div>
