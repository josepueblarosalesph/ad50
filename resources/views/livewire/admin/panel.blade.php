<div>
    ...
    <div class="grid sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
        @foreach ([['Empresas activas', $totalEmpresas, $empresasPendientes.' pendientes de revisión'], ['Postulantes', $totalPostulantes, 'Perfiles profesionales'], ['Búsquedas activas', $totalBusquedas, 'Búsquedas en curso'], ['Coincidencias generadas', $totalCoincidencias, 'Matches acumulados']] as [$label, $value, $detail])
