<x-layouts.marketing title="Iniciar sesión · AD+50">
    <main class="grid min-h-screen bg-paper lg:grid-cols-[1.08fr_.92fr]">
        <section
            ...
            style="background-image: linear-gradient(180deg, rgba(52,54,56,.5) 0%, rgba(52,54,56,.76) 48%, rgba(52,54,56,.97) 100%), url('/images/ad50-hero-profesionales-trabajando-v2.webp'); background-position: 66% center; background-size: cover;"
        >
